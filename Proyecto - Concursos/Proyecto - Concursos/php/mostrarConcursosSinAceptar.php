<?php	
	...
	$query = "select idConcurso as 'ID de concurso', nombreConcurso as 'Nombre', hashtag as 'Hashtag de Twitter', dificultad as 'Dificultad', categoria as 'Categoria',
	 fechaDeAlta as 'Fecha de Alta', fechaDeInicio as 'Fecha de inicio', descripcion as 'Descripcion', fechaDeFin as 'Fecha de fin', 
	 usuarioGanador as 'Usuario ganador', usuarioOrganizador as 'Usuario creador' from concurso where status != 2";
	...
	echo "<br /><h1><strong><p style='color: white; text-align:center;'>Concursos sin aceptar:</p></strong></h1>";
